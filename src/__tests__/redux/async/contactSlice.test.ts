...
import contactReducer, { postSubscription, ContactState } from '../../../redux/async/contactSlice';
...
describe('contactSlice', () => {
  ...
  it('should handle postSubscription successfully', async () => {
    ...
    await store.dispatch(postSubscription('example@example.com') as any);
  ...
  it('should handle postSubscription failure', async () => {
    ...
    await store.dispatch(postSubscription('invalid-email') as any);
